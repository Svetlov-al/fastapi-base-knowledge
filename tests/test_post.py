...
def test_get_all_posts(authorized_client, test_posts):
    ...
    posts_map = map(validate, test_posts)
...
def get_one_post(authorized_client, test_posts):
...
@pytest.mark.parametrize('title, content, published',
                         [("awesome new title", "awesome new content", True),
                          ("awesome super_new title",
                           "awesome super_new content", False),
                          ("awesome super_duper_new title", "awesome super_duper_new content", True)])
